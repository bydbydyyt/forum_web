    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background', models.ImageField(blank=True, null=True, upload_to='backgrounds/', verbose_name='背景图片')),
                ('bio', models.TextField(blank=True, max_length=500, verbose_name='个人简介')),
                ('friend_code', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='好友代码')),
                ...
                ('show_collections', models.BooleanField(default=True, verbose_name='显示收藏夹')),
